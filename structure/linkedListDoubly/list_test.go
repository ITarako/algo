...
func TestDoublyLinkedList_New1(t *testing.T) {
...
func TestDoublyLinkedList_AddFirst(t *testing.T) {
	t.Run("1", func(t *testing.T) {
		...
		assert.Equal(t, list.Head.Prev, list.Tail)
...
func TestDoublyLinkedList_AddFirstRemoveFirst(t *testing.T) {
	t.Run("1", func(t *testing.T) {
		list := NewDoublyLinkedList()
		err := list.RemoveFirst()

		assert.EqualError(t, err, ErrDoublyLinkedListIsEmpty.Error())
	})
...
func TestDoublyLinkedList_AddFirstRemoveLast(t *testing.T) {
	t.Run("1", func(t *testing.T) {
		list := NewDoublyLinkedList()
		err := list.RemoveLast()
...
func TestDoublyLinkedList_AddLastRemoveFirst(t *testing.T) {
	t.Run("1", func(t *testing.T) {
		list := NewDoublyLinkedList()
		err := list.RemoveFirst()
...
func TestDoublyLinkedList_AddLastRemoveLast(t *testing.T) {
	t.Run("1", func(t *testing.T) {
		list := NewDoublyLinkedList()
		err := list.RemoveLast()
